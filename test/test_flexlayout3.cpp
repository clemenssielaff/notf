...
SCENARIO("A FlexLayout places its children without wrapping #3", "[dynamic][layout]")
{
    std::shared_ptr<FlexLayout> flexlayout = FlexLayout::create();
    flexlayout->set_claim(Claim::fixed(400, 400));

    WHEN("you add multiple widgets to a no-wrap overlayout with cross-alignment set to 'center'")
    {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        THEN("the child aabr of the FlexLayout is the narrow bounding rect around the 3 items")
                        {
                            ...
                            REQUIRE(child_size == Size2f(350, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 350));
                        }
                    }
            ...
            WHEN("you set non-zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(370, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 370));
                        }
                    }
            ...
            WHEN("you set zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(400, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 400));
                        }
                    }
                ...
                WHEN("you set non-zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(360, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 360));
                        }
                    }
            ...
            WHEN("you set zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(375, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 375));
                        }
                    }
                ...
                WHEN("you set non-zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(355, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 355));
                        }
                    }
            ...
            WHEN("you set non-zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(385, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 385));
                        }
                    }
                ...
                WHEN("you set non-zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(365, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 365));
                        }
                    }
            ...
            WHEN("you set zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(400 - spacing * 2, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to right-to-left")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size.is_approx(Size2f(400 - spacing * 2, 200), 0.1f));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size.is_approx(Size2f(200, 400 - spacing * 2), 0.1f));
                        }
                    }
                ...
                WHEN("you set non-zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size.is_approx(Size2f(360 - spacing * 2, 200), 0.1f));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size.is_approx(Size2f(200, 360 - spacing * 2), 0.1f));
                        }
                    }
            ...
            WHEN("you set non-zero spacing")
            {
                ...
                WHEN("you set zero padding")
                {
                    ...
                    WHEN("you set the direction to left-to-right")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(390, 200));
                        }
                    }
                    ...
                    WHEN("you set the direction to top-to-bottom")
                    {
                        ...
                        {
                            const Size2f child_size = flexlayout->get_child_aabr().get_size();
                            REQUIRE(child_size == Size2f(200, 390));
                        }
                    }
