...
static_assert(std::is_pod<Matrix4f>::value,
              "This compiler does not recognize notf::Matrix4f as a POD.");
...
static_assert(std::is_pod<Matrix4d>::value,
              "This compiler does not recognize notf::Matrix4d as a POD.");
