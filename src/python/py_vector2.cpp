...
void produce_vector2(pybind11::module& module)
{
    ...
    Py_Vector2.def("is_zero", (bool (Vector2::*)(float) const) & Vector2::is_zero, "Checks if this Vector2 is the zero vector.", py::arg("epsilon"));
    ...
    module.def("lerp", (Vector2(*)(const Vector2&, const Vector2&, float)) & lerp, "Linear interpolation between two Vector2s.", py::arg("from"), py::arg("to"), py::arg("blend"));
    module.def("nlerp", (Vector2(*)(const Vector2&, const Vector2&, float)) & nlerp, "Normalized linear interpolation between two Vector2s.", py::arg("from"), py::arg("to"), py::arg("blend"));
}
