...
void produce_stack_layout(pybind11::module& module, py::detail::generic_type ancestor)
{
    ...
    Py_StackLayout.def("get_wrapping", &StackLayout::get_wrapping, "How items are wrapped.");
    ...
    Py_StackLayout.def("set_wrapping", &StackLayout::set_wrapping, "Defines how items are wrapped.", py::arg("wrap"));
