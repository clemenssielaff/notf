...
void gl_log_system_info() {
    NOTF_LOG_INFO("OpenGL ES version:    {}", glGetString(GL_VERSION));
    NOTF_LOG_INFO("OpenGL ES vendor:     {}", glGetString(GL_VENDOR));
    NOTF_LOG_INFO("OpenGL ES renderer:   {}", glGetString(GL_RENDERER));
    NOTF_LOG_INFO("OpenGL ES extensions: {}", glGetString(GL_EXTENSIONS));
    NOTF_LOG_INFO("GLSL version:         {}", glGetString(GL_SHADING_LANGUAGE_VERSION));
}
...
const std::string& gl_type_name(GLenum type) {
    ...
    switch (type) {
    case GL_FLOAT: return t_float;
    case GL_FLOAT_VEC2: return t_vec2;
    case GL_FLOAT_VEC3: return t_vec3;
    case GL_FLOAT_VEC4: return t_vec4;
    case GL_INT: return t_int;
    case GL_INT_VEC2: return t_ivec2;
    case GL_INT_VEC3: return t_ivec3;
    case GL_INT_VEC4: return t_ivec4;
    case GL_UNSIGNED_INT: return t_unsigned_int;
    case GL_UNSIGNED_INT_VEC2: return t_uvec2;
    case GL_UNSIGNED_INT_VEC3: return t_uvec3;
    case GL_UNSIGNED_INT_VEC4: return t_uvec4;
    case GL_BOOL: return t_bool;
    case GL_BOOL_VEC2: return t_bvec2;
    case GL_BOOL_VEC3: return t_bvec3;
    case GL_BOOL_VEC4: return t_bvec4;
    case GL_FLOAT_MAT2: return t_mat2;
    case GL_FLOAT_MAT3: return t_mat3;
    case GL_FLOAT_MAT4: return t_mat4;
    case GL_FLOAT_MAT2x3: return t_mat2x3;
    case GL_FLOAT_MAT2x4: return t_mat2x4;
    case GL_FLOAT_MAT3x2: return t_mat3x2;
    case GL_FLOAT_MAT3x4: return t_mat3x4;
    case GL_FLOAT_MAT4x2: return t_mat4x2;
    case GL_FLOAT_MAT4x3: return t_mat4x3;
    case GL_SAMPLER_2D: return t_sampler2D;
    case GL_SAMPLER_3D: return t_sampler3D;
    case GL_SAMPLER_CUBE: return t_samplerCube;
    case GL_SAMPLER_2D_SHADOW: return t_sampler2DShadow;
    case GL_SAMPLER_2D_ARRAY: return t_sampler2DArray;
    case GL_SAMPLER_2D_ARRAY_SHADOW: return t_sampler2DArrayShadow;
    case GL_SAMPLER_2D_MULTISAMPLE: return t_sampler2DMS;
    case GL_SAMPLER_CUBE_SHADOW: return t_samplerCubeShadow;
    case GL_INT_SAMPLER_2D: return t_isampler2D;
    case GL_INT_SAMPLER_3D: return t_isampler3D;
    case GL_INT_SAMPLER_CUBE: return t_isamplerCube;
    case GL_INT_SAMPLER_2D_ARRAY: return t_isampler2DArray;
    case GL_INT_SAMPLER_2D_MULTISAMPLE: return t_isampler2DMS;
    case GL_UNSIGNED_INT_SAMPLER_2D: return t_usampler2D;
    case GL_UNSIGNED_INT_SAMPLER_3D: return t_usampler3D;
    case GL_UNSIGNED_INT_SAMPLER_CUBE: return t_usamplerCube;
    case GL_UNSIGNED_INT_SAMPLER_2D_ARRAY: return t_usampler2DArray;
    case GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE: return t_usampler2DMS;
    case GL_IMAGE_2D: return t_image2D;
    case GL_IMAGE_3D: return t_image3D;
    case GL_IMAGE_CUBE: return t_imageCube;
    case GL_IMAGE_2D_ARRAY: return t_image2DArray;
    case GL_INT_IMAGE_2D: return t_iimage2D;
    case GL_INT_IMAGE_3D: return t_iimage3D;
    case GL_INT_IMAGE_CUBE: return t_iimageCube;
    case GL_INT_IMAGE_2D_ARRAY: return t_iimage2DArray;
    case GL_UNSIGNED_INT_IMAGE_2D: return t_uimage2D;
    case GL_UNSIGNED_INT_IMAGE_3D: return t_uimage3D;
    case GL_UNSIGNED_INT_IMAGE_CUBE: return t_uimageCube;
    case GL_UNSIGNED_INT_IMAGE_2D_ARRAY: return t_uimage2DArray;
    case GL_UNSIGNED_INT_ATOMIC_COUNTER: return t_atomic_uint;
    }
    return t_unknown;
}
