...
struct GlfwEventHandler {
    ...
    /// @param modifiers    Modifier key bitmask.
    static void on_char_input(GLFWwindow* glfw_window, uint codepoint) {}

    /// Called by GLFW when the user presses a key combination with at least one modifier key.
    /// @param glfw_window  The GLFWwindow targeted by the event
    /// @param codepoint    Unicode code point generated by the event as native endian UTF-32.
    /// @param modifiers    Modifier key bitmask.
    static void on_shortcut(GLFWwindow* glfw_window, uint codepoint, int modifiers) {}
    ...
    static void on_window_move(GLFWwindow* glfw_window, int x, int y) {}
...
NOTF_LOG_TRACE("jp");
        TheApplication::get_scheduler().schedule(std::make_unique<WindowResizeEvent>( //
            to_window_handle(glfw_window),                                            //
            Size2i{width, height}                                                     //
            ));
    }
    ...
    static void on_framebuffer_resize(GLFWwindow* glfw_window, int width, int height) {}
    ...
    static void on_window_focus(GLFWwindow* glfw_window, int kind) {}

    /// Called when the Window is minimzed.
    /// @param glfw_window  The GLFWwindow targeted by the event.
    /// @param kind         Is GLFW_TRUE when the Window was minimized, or GLFW_FALSE if it was restored.
    static void on_window_minimize(GLFWwindow* glfw_window, int kind) {}
    ...
    static void on_file_drop(GLFWwindow* glfw_window, int count, const char** paths) {}
    ...
    static void on_monitor_change(GLFWmonitor* glfw_monitor, int kind) {}
    ...
    static void on_joystick_change(int joystick, int kind) {}
