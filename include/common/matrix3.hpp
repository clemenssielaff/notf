...
struct _Matrix3 : public detail::Arithmetic<_Matrix3<REAL>, _RealVector2<REAL>, 3> {
    ...
    _Matrix3(const element_t a)
        : super_t{component_t(a, 0),
                  component_t(0, a),
                  component_t(0, 0)} {}
    ...
    _Matrix3(const element_t a, const element_t b,
             const element_t c, const element_t d,
             const element_t e, const element_t f)
        : super_t{component_t(a, b),
                  component_t(c, d),
                  component_t(e, f)} {}
    ...
    {
        return _Matrix3(component_t(1, 0),
                        component_t(0, 1),
    ...
    static _Matrix3 scaling(const element_t factor)
    {
        return _Matrix3(factor, 0,
                        0, factor,
                        0, 0);
    }
    ...
    static _Matrix3 scaling(const component_t& vec)
    {
        return _Matrix3(vec[0], 0,
                        0, vec[1],
                        0, 0);
    }
    ...
    static _Matrix3 skew(const component_t& vec)
    {
        return _Matrix3(1, tan(vec[1]),
                        tan(vec[0]), 1,
                        0, 0);
    }
    ...
    {
        return (1 - determinant()) < precision_high<element_t>();
    }
    ...
    _Matrix3 premult(const _Matrix3& other) const
    {
        return other * *this;
    }
    ...
    template <typename T>
    T transform(const T& value) const { return detail::matrix3_transform(*this, value); }
};
