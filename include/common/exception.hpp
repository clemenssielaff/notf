...
/// @brief Specialized Exception thrown when you try to destroy the universe.
...
/// @brief Specialized Exception that logs the message and then behaves like a regular std::runtime_error.
...
/// @brief Convenience macro to throw a notf::runtime_error that contains the line, file and function where the error
/// occured.
