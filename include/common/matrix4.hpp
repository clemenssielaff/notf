...
struct Matrix4 : public detail::Arithmetic<Matrix4<REAL>, RealVector4<REAL>, 4> {
    ...
    Matrix4 rotate(RealVector3<element_t> axis, const element_t radian) const
    {
        ...
        axis.normalize();
        const RealVector3<element_t> temp = axis * (1 - cos_angle);
    ...
    RealVector4<element_t> transform(const RealVector4<element_t>& vector) const
    {
        ...
        const RealVector4<element_t> mul0 = data[0] * RealVector4<element_t>::fill(vector[0]);
        const RealVector4<element_t> mul1 = data[1] * RealVector4<element_t>::fill(vector[1]);
        const RealVector4<element_t> mul2 = data[2] * RealVector4<element_t>::fill(vector[2]);
        const RealVector4<element_t> mul3 = data[3] * RealVector4<element_t>::fill(vector[3]);
    ...
    RealVector2<element_t> transform(const RealVector2<element_t>& vector) const
    {
        const RealVector4<element_t> mul0   = data[0] * RealVector4<element_t>::fill(vector[0]);
        const RealVector4<element_t> mul1   = data[1] * RealVector4<element_t>::fill(vector[1]);
        const RealVector4<element_t> result = (mul0 + mul1) + data[3];
