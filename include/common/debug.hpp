...
#define log_fatal untitled::LogMessageFactory(untitled::LogMessage::LEVEL::FATAL, __LINE__, untitled::basename(__FILE__), __FUNCTION__).input
#else
#define log_fatal untitled::_NullBuffer()
#endif
#else
...
#define log_critical untitled::LogMessageFactory(untitled::LogMessage::LEVEL::CRITICAL, __LINE__, untitled::basename(__FILE__), __FUNCTION__).input
#else
#define log_critical untitled::_NullBuffer()
#endif
#else
...
#define log_warning untitled::LogMessageFactory(untitled::LogMessage::LEVEL::WARNING, __LINE__, untitled::basename(__FILE__), __FUNCTION__).input
#else
#define log_warning untitled::_NullBuffer()
#endif
#else
...
#define log_info untitled::LogMessageFactory(untitled::LogMessage::LEVEL::INFO, __LINE__, untitled::basename(__FILE__), __FUNCTION__).input
#else
#define log_info untitled::_NullBuffer()
#endif
#else
...
#define log_debug untitled::LogMessageFactory(untitled::LogMessage::LEVEL::DEBUG, __LINE__, untitled::basename(__FILE__), __FUNCTION__).input
#else
#define log_debug untitled::_NullBuffer()
#endif
#else
