...
// TODO: make_generator is useless if you don't make the function signatures make sense, also the overloads don't work
...
//                detail::make_generator_iterator_only<Policy>(std::forward<Data>(data),
//                std::forward<Iterate>(iterate)))
//{
...
//                                                              std::forward<Predicate>(predicate)))
//{
//    return detail::make_generator_predicate_only<Policy>(std::forward<Data>(data),
//    std::forward<Predicate>(predicate));
//}
