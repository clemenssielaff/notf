...
private: // methods *************************************************************************************************/
     ...
     */
    PrefabInstance(std::shared_ptr<PrefabType<InstanceData>> prefab_type)
        : m_prefab(std::move(prefab_type))
        , m_data()
    {
    }
...
protected: // methods *************************************************************************************************/
    ...
    static std::shared_ptr<PrefabType<InstanceData>> create(
        const std::string name, const size_t offset, const size_t size)
    {
#ifdef _DEBUG
