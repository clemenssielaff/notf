 ...
 * This behaviour is similar to the handling of Textures.
 */
...
public: // static methods *********************************************************************************************/
    ...
    load(GraphicsContext& context, const std::string& name, const std::string& vertex_shader_file,
     ...
     */
    static std::shared_ptr<Shader>
    build(GraphicsContext& context, const std::string& name, const std::string& vertex_shader_source,
