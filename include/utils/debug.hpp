...
public: // methods
    ...
    DebugTimer(const std::string& name) : m_name(name), m_start(std::chrono::high_resolution_clock::now()) {}
...
private: // fields
    /// Name of the DebugTimer to identify the output.
    std::string m_name;

    /// High-precision construction time of the timer.
