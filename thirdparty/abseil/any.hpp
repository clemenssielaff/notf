...
// Note by Clemens Sielaff, March 10th 2018
// This is a modified version of the file:
//  https://raw.githubusercontent.com/abseil/abseil-cpp/0ec11bad6fc18822e851b25344f027491cc85746/absl/types/any.h
...
public:
    ...
    bad_any_cast(const bad_any_cast& rhs) = default;
    virtual ~bad_any_cast() noexcept override;
...
private:
    ...
    const void* GetObjTypeId() const { return obj_ ? obj_->ObjTypeId() : any_internal::FastTypeId<void>(); }
...
const T* any_cast(const any* operand) noexcept
{
    return operand && operand->GetObjTypeId() == any::IdForType<T>() ?
               std::addressof(static_cast<const any::Obj<T>*>(operand->obj_.get())->value) :
               nullptr;
}
...
{
    return operand && operand->GetObjTypeId() == any::IdForType<T>() ?
               std::addressof(static_cast<any::Obj<T>*>(operand->obj_.get())->value) :
               nullptr;
}
